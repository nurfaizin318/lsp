  ...
  <div style="width:100%;justify-content: center;align-items: center;padding: 20px;">
    ...
    <table class="table w-50 mt-5 text-center ">
      <thead>
        <tr>
        <th scope="col">No</th>
        <th scope="col">kode_kasir</th>
          <th scope="col">nama kasir</th>
          <th scope="col">password kasir</th>
...
include "../koneksi.php";
$no = 1;
$data = mysqli_query($koneksi,"select * from tblkasir");
...
?>
        <tr>
          ...
          <td><?php echo $d["password_kasir"]; ?></td>

          <td>
            <a href="edit.php?kode_kasir=<?php echo $d["kode_kasir"]; ?>">
              <button type="button" class="btn btn-warning">edit</button>
            </a>
            <a href="hapus.php?kode_kasir=<?php echo $d["kode_kasir"]; ?>">
