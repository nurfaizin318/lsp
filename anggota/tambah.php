...
<body >
<div class="jumbotron">
  <h1 class="display-4">Tambah Anggota!</h1>
  <hr class="my-4">
  <form action="tambah_aksi.php" method="post">
            ...
            <div class="form-group " style="width: 300px;">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1"  name="wajib">
             
            </div>
            <div class="form-group" style="width: 300px;">
              <label for="exampleInputPassword1">pokok</label>
              <input type="text" class="form-control" id="exampleInputPassword1" name="pokok">
            </div>
            <div class="form-group" style="width: 300px;">
